...
import (
	...
	"github.com/umbrellala/unioffice/schema/soo/ofc/extended_properties"
)
...
func NewAppProperties() AppProperties {
	...
	p.SetApplication("github.com/umbrellala/unioffice")
	p.SetDocSecurity(0)
...
// For gooxml created documents, it defaults to github.com/umbrellala/unioffice
